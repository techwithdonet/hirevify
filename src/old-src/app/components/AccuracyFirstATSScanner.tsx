      ...
      const fallbackData: EnterpriseResumeData = {
        ...
        extractionMetadata: {
          ...
          enhancementNotes: [
            ...
            '• Consider converting to a simpler format (PDF → Word → Text)',
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {analysisResult.personalInfo.linkedin && (
                      <div className="flex items-center gap-2">
                        <Linkedin className="w-4 h-4 text-gray-500" />
                        <span className="font-medium">LinkedIn:</span>
                        <span className="text-blue-600">{analysisResult.personalInfo.linkedin}</span>
                      </div>
                    )}
                    {analysisResult.personalInfo.github && (
                      <div className="flex items-center gap-2">
                        <Github className="w-4 h-4 text-gray-500" />
                        <span className="font-medium">GitHub:</span>
                        <span className="text-blue-600">{analysisResult.personalInfo.github}</span>
                      </div>
                    )}
                  </div>
                </div>
