      ...
      projects: [
        {
          ...
          url: 'github.com/candidate/ecommerce'
        }
      ],
      certifications: [
        {
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="space-y-2">
                        ...
                        {scanResult.personalInfo.linkedin && (
                          <div className="flex items-center gap-2">
                            <ExternalLink className="w-4 h-4 text-gray-500" />
                            <span className="font-medium">LinkedIn:</span>
                            <span className="text-blue-600">{scanResult.personalInfo.linkedin}</span>
                          </div>
                        )}
                        {scanResult.personalInfo.github && (
                          <div className="flex items-center gap-2">
                            <ExternalLink className="w-4 h-4 text-gray-500" />
                            <span className="font-medium">GitHub:</span>
                            <span className="text-blue-600">{scanResult.personalInfo.github}</span>
                          </div>
                        )}
                      </div>
                    </div>
