...
const trialProjects: TrialProject[] = [
  {
    ...
    requirements: ['Basic React knowledge', 'Git/GitHub experience', 'Available 20+ hours/week'],
    ...
    setExperienceRecords([
      {
        ...
        referenceUrl: 'https://linkedin.com/in/mentor-reference',
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="flex items-center text-sm text-muted-foreground mb-2">
                            ...
                            {project.company} • {project.companySize}
                          </div>
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-2">
                        {userExperience?.status === 'completed' ? (
                          ...
                          >
                            <Play className="w-4 h-4 mr-2" />
                            Apply Now • {project.applicants} applied
                          </Button>
                        )}
                      </div>
                    </CardContent>
