...
export function OTPVerification({ email, type, onBack, onVerify, onResend }: OTPVerificationProps) {
 ...
 {type === 'signup'? 'Enter the 6-digit verification code sent to your email to complete your registration.': 'Enter the 6-digit verification code sent to your email to sign in securely.'
 }
 </CardDescription>
 </div>
