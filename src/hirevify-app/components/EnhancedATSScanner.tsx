...
export function EnhancedATSScanner({ 
 ...
 averageScore: candidates.length > 0? Math.round(candidates.reduce((sum, c) => sum + c.atsScore.overall, 0) / candidates.length): 0
 };
 ...
 {mode === 'recruiter'? 'Enterprise-grade resume analysis for recruiters': 'Comprehensive resume optimization for candidates'
 }
 </p>
 </div>
 </div>
