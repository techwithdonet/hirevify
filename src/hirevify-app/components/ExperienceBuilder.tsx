                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="flex items-center text-sm text-muted-foreground mb-2">
                            ...
                            {project.company} ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ {project.companySize}
                          </div>
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-2">
                        {userExperience?.status === 'completed' ? (
                          ...
                          >
                            <Play className="w-4 h-4 mr-2" />
                            Apply Now ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ {project.applicants} applied
                          </Button>
                        )}
                      </div>
                    </CardContent>
                        ...
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground mb-2">
                              {project.company} ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ {project.location}
                            </div>
