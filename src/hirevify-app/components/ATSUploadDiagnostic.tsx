            ...
            {selectedFile && (
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <div className="text-sm text-gray-600 mt-1">
                  Size: {(selectedFile.size / 1024).toFixed(1)} KB ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ Type: {selectedFile.type}
                </div>
              </div>
            )}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 rounded-lg p-3">
              ...
              <ul className="text-xs text-blue-700 mt-1 space-y-1">
                <li>ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ Functional ATS Scanner: <code>/?screen=functional-ats</code></li>
                <li>ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ Accuracy-First Scanner: <code>/?screen=accuracy-first-ats</code></li>
                <li>ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ Upload Diagnostic: <code>/?diagnostic=ats</code></li>
              </ul>
            </div>
          </div>
        </CardContent>
