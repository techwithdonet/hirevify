        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-full shadow-lg">
            ...
            <span className="text-sm text-gray-600">
              Revolutionary hiring platform ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒ¢Ã¢â€š¬Ã‚ Join the{' '}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚© 2024 HireVify. All rights reserved.
            </p>
            <p className="text-gray-400">
              Made with ÃƒÆ’Ã‚¢Ãƒâ€šÃ‚Ãƒâ€šÃ‚¤ÃƒÆ’Ã‚¯Ãƒâ€šÃ‚¸Ãƒâ€šÃ‚ for better hiring
            </p>
          </div>
        </div>
      </footer>
