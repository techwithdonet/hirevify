  ...
  const handleFileUpload = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        console.log(`ÃƒÆ’Ã‚°Ãƒâ€¦Ã‚¸Ãƒ¢Ã¢â€š¬Ã…"Ãƒ¢Ã¢â€š¬Ã…¾ Processing document: ${file.name}`);
        ...
        console.log(`ÃƒÆ’Ã‚°Ãƒâ€¦Ã‚¸Ãƒâ€šÃ‚¤Ãƒ¢Ã¢â€š¬Ã¢â‚¬Å“ Extracting data from: ${file.name}`);
        ...
        console.log(`ÃƒÆ’Ã‚°Ãƒâ€¦Ã‚¸Ãƒ¢Ã¢â€š¬Ã…"Ãƒâ€¦Ã‚  Calculating ATS scores for: ${file.name}`);
        ...
        console.log(`ÃƒÆ’Ã‚¢Ãƒâ€¦Ã¢â‚¬Å“Ãƒ¢Ã¢â€š¬Ã‚¦ Successfully processed: ${file.name}`, {
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-4">
                <Button variant="ghost" size="sm" onClick={() => setSelectedResult(null)}>
                  ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â€š¬Ã‚ Ãƒâ€šÃ‚ Back to Results
                </Button>
                <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {selectedResult.extractedData.personalInfo.Link && (
                      <div>
                        <label className="text-sm font-medium text-gray-500">Link</label>
                        <p className="text-lg">{selectedResult.extractedData.personalInfo.Link}</p>
                      </div>
                    )}
                    {selectedResult.extractedData.personalInfo.GitBranch && (
                      <div>
                        <label className="text-sm font-medium text-gray-500">GitBranch</label>
                        <p className="text-lg">{selectedResult.extractedData.personalInfo.GitBranch}</p>
                      </div>
                    )}
                  </div>
                </CardContent>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Button variant="ghost" size="sm" onClick={onBack}>
                ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â€š¬Ã‚ Ãƒâ€šÃ‚ Back to Dashboard
              </Button>
              <div>
                <h1 className="text-xl font-semibold flex items-center">
                  <Brain className="w-5 h-5 mr-2 text-primary" />
                ...
                <p className="text-sm text-gray-500">Real AI extraction with 95%+ accuracy ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚¢ Powered by GPT-4</p>
              </div>
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-4 ml-6">
                        ...
                        <div className="text-gray-400">
                          ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â€š¬Ã‚ Ãƒ¢Ã¢â€š¬Ã¢â€ž¢
                        </div>
                      </div>
                    </div>
                  </CardContent>
