...
export function ProfessionalATSScanner() {
 ...
 console.log('... Attempting Microsoft Form Recognizer parsing...');
 ...
 console.log('... Attempting Adobe PDF Services parsing...');
 ...
 console.log('... Using internal enhanced parser as fallback...');
 ...
 const optimalService = selectedService === 'auto'? selectOptimalParsingService(uploadedFile): selectedService;
 ...
 (selectedService === 'auto' && service.name.includes('Auto'))? 'border-primary bg-primary/5': 'border-gray-200 hover:border-gray-300'
 }`}
 ...
 uploadedFile? 'border-green-300 bg-green-50': 'border-gray-300 hover:border-primary'
 }`}
 onDrop={handleDrop}
 ...
 {edu.field} Graduated: {edu.graduationDate}
 </p>
 {edu.gpa && (
 ...
 {scanResult.workExperience.length > 0? Math.round((scanResult.workExperience[0].confidence || 0) * 100): 0}%
 </div>
 <p className="text-sm text-gray-600">Work Experience</p>
 </div>
 <div className="text-center p-4 bg-purple-50 rounded-lg">
 <div className="text-2xl font-bold text-purple-600">
 {scanResult.education.length > 0? Math.round((scanResult.education[0].confidence || 0) * 100): 0}%
 </div>
