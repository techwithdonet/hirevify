 ...
 */
 ...
 console.log(`Done Enhanced PDF parsing completed in ${processingTime}ms`);
 ...
 console.error('Error Enhanced PDF parsing failed:', error);
 ...
 const filtered = matches.filter(match =>!match.includes('@') &&!match.includes('Link.com') &&!match.includes('GitBranch.com') &&!match.includes('gmail.com') &&!match.includes('yahoo.com') &&!match.includes('outlook.com')
 );
 ...
 console.log('Done Personal info extracted:', { fullName, email, phone, location, Link, GitBranch, website, confidence });
 ...
 console.log('Warning No experience section found, trying to extract from all content...');
 ...
 console.log(`Done Extracted ${experiences.length} work experiences`);
 return experiences;
 }
 ...
 console.log('Warning No education section found, trying to extract from all content...');
 ...
 console.log(`Done Extracted ${education.length} education entries`);
 return education;
 }
 ...
 console.log('ݕ Extracting skills with advanced recognition...');
 ...
 const textToAnalyze = skillsSections.length > 0? skillsSections.map(s => s.content.join(' ')).join(' '): fullText;
 ...
 console.log('Done Skills extracted:', {
 ...
 const contentToSearch = certSections.length > 0? certSections.map(s => s.content).flat(): lines;
 ...
 console.log(`Done Extracted ${certifications.length} certifications`);
 return certifications;
 }

 private extractLanguagesAdvanced(fullText: string, sections: PDFSection[]): Language[] {
 console.log('ѕ Extracting languages...');
 ...
 const textToSearch = languageSections.length > 0? languageSections.map(s => s.content.join(' ')).join(' '): fullText;
 ...
 console.log(`Done Extracted ${languages.length} languages`);
 return languages;
 }
 ...
 console.log('Warning No project section found');
 return projects;
 }
 ...
 console.log(`Done Extracted ${projects.length} projects`);
 return projects;
 }
 ...
 /^[A-Z]/.test(text) &&!this.isJobTitle(text) &&!this.isCompanyName(text);
 }
