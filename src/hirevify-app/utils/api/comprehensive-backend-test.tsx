...
async function testBasicServerConnectivity(): Promise<DiagnosticResult> {
 ...
 console.log('Done Basic server connectivity successful:', data);
 ...
 console.log('Error Basic server connectivity failed:', response.status, errorText);
...
async function testMainHealthEndpoints(): Promise<DiagnosticResult[]> {
 ...
 console.log(`Done ${endpoint.name} successful`);
 ...
 console.log(`Error ${endpoint.name} failed:`, response.status);
...
async function testIntegrationEndpoints(): Promise<DiagnosticResult[]> {
 ...
 console.log(`Done ${endpoint.name} successful:`, data);
 ...
 console.log(`Error ${endpoint.name} failed:`, response.status, errorText);
...
export async function isBackendReachable(): Promise<boolean> {
 ...
 if (response.ok) {
 console.log('Done Backend is reachable via:', url);
 return true;
 }
 } catch {
 ...
 console.log('Error Backend is not reachable via any endpoint');
 return false;
}
