...
export async function testIntegrationRoutes(): Promise<{ success: boolean; routes?: any; error?: string }> {
 ...
 console.error('Error Integration routes test failed:', error);
 return {
 success: false,
...
export async function testIntegrationKV(): Promise<{ success: boolean; error?: string; data?: any }> {
 try {
 console.log('—„ï Testing integration service KV access...');
 ...
 const data = await response.json();
 console.log('—„ï KV test response:', data);
 ...
 console.error('Error Error testing KV:', error);
 return {
 success: false,
...
export async function debugIntegrationAuth(accessToken: string): Promise<{ success: boolean; user?: any; error?: string; debug?: any }> {
 ...
 console.log('—„ï Testing KV access...');
 let kvTest;
 try {
 kvTest = await testIntegrationKV();
 console.log('—„ï KV test result:', kvTest.success? 'PASSED': 'FAILED');
 } catch (kvError) {
 console.log('—„ï KV test failed with error:', kvError.message);
 kvTest = {
 success: false,
 ...
 console.error('Error Error in debug auth:', error);
 return {
 success: false,
...
export async function getUserIntegrations(accessToken: string): Promise<{ success: boolean; integrations?: Integration[]; error?: string }> {
 ...
 console.error('Error Integration service health check failed:', healthResult.error);
 return {
 success: false,
 ...
 console.log('Done Integration service is accessible:', healthResult.status);
 } catch (healthError) {
 console.error('Error Integration service connectivity test failed:', healthError);
 return {
 success: false,
 ...
 console.error('Error Error fetching user integrations:', error);
