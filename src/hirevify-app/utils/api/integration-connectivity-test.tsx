...
export async function testIntegrationConnectivity(): Promise<ConnectivityTestResult> {
 ...
 console.log(`Warning ${endpoint.name} returned ${response.status}`);
 ...
 console.log(`Warning ${endpoint.name} failed:`, errorMessage);
 
 // Handle specific error types
 if (error.name === 'AbortError') {
 console.log(`Warning ${endpoint.name} timed out after ${endpoint.timeout}ms`);
 } else if (error instanceof TypeError && errorMessage.includes('fetch')) {
 console.log(`Warning ${endpoint.name} network error:`, errorMessage);
 }
...
export async function testAuthenticatedIntegrationEndpoints(accessToken: string): Promise<ConnectivityTestResult> {
 ...
 console.log('Done Authenticated Integration Hub test successful:', data);
 ...
 console.log('Error Authenticated Integration Hub test failed:', errorData);
