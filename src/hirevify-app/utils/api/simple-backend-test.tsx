...
export async function testBasicBackend(): Promise<SimpleTestResult> {
 ...
 console.error('Error Backend test failed:', error.message);
...
export async function testMultipleEndpoints(): Promise<{
 ...
 console.log(`Done ${endpoint.name} passed`);
 } else {
 results.push({
 success: false,
 ...
 console.log(`Error ${endpoint.name} error:`, error.message);
 }
 }
...
export async function quickHealthCheck(): Promise<{
 ...
 responseTime,
 message: response.ok? `Backend is online (${responseTime}ms)`: `Backend returned ${response.status} (${responseTime}ms)`
 };
