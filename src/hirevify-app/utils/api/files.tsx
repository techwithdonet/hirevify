...
export class FilesAPI {
 ...
 const url = projectId? `${API_BASE}/project-challenge-videos?projectId=${projectId}`: `${API_BASE}/project-challenge-videos`
 ...
 if (!accessToken) {
 console.error('Error No access token provided to processResumeATS');
 ...
 if (!response.ok) {
 console.error('Error ATS API Error Response:', {
 status: response.status,
 statusText: response.statusText,
 result
 });
 ...
 console.log('Done ATS processing completed successfully');
 return result
 }
