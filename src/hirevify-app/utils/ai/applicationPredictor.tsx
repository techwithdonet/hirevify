 ...
 */
 ...
 const relevantExperience = candidate.experience.filter(exp => exp.industry === job.industry || exp.skills.some(skill => 
 ...
 */
 ...
 const matchedSkills = job.requiredSkills.filter(req => candidateSkillNames.includes(req.name.toLowerCase())).map(req => req.name);
