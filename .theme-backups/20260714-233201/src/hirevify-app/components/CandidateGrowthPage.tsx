...
import { Award, BookOpen, Briefcase, Building, CheckCircle, Clock, Download, FileText, MapPin, Play, Target, Upload } from 'lucide-react';
...
export function CandidateGrowthPage({
 ...
 return (
  <DashboardPageLayout
   ...
   shellClassName="workspace-growth-page pb-16"
  >
